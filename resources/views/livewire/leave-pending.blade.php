    ...
    <div class="detail-container" style="display: flex;flex-direction: column;width: 100%;gap: 10px;background-color: none;">
           ...
           <div class="heading" style=" width: 100%;background: #fff;margin-top:-10px;border: 1px solid #ccc;border-radius:5px;">
                <div class="heading-2" >
                    ...
                    <div class="field m-0" style=" display: flex;justify-content: center;flex-direction: column;">
                            ...
                            @if(strtoupper($leaveRequest->status) == 'WITHDRAWN')
                                <span style="color: #333; font-weight: 500; text-transform: uppercase;font-size:12px;">
                                    {{ $this->leaveRequest->employee->first_name }} {{ $this->leaveRequest->employee->last_name }}
                                </span>
                                @elseif(is_array($leaveRequest['applying_to']) || is_object($leaveRequest['applying_to']))
            ...
            <div class="middle-container m-0 px-4 " style=" background: transparent;display:flex;flex-direction:row;justify-content:space-between;">
                <div class="view-container p-0 m-0" style="border:1px solid #ccc; background:#ffffe8; display:flex; width:70%; border-radius:5px; height:auto;">
                     <div class="history-list m-0 p-0" style="display:flex; gap:40px;text-align:center;">
                            <div class="field m-0 p-3 " style=" display: flex;justify-content: center;flex-direction: column;">
                                ...
                                <span style="font-size: 12px; font-weight: 600;"> {{ $leaveRequest->from_date->format('d M, Y') }}<br><span style="color: #494F55;font-size: 0.755rem; font-weight: normal;">{{ $leaveRequest->from_session }}</span></span>
                            </div>
                            <div class="field m-0 p-3 " style=" display: flex;justify-content: center;flex-direction: column;">
                                <span style="color: #778899; font-size:10px; font-weight: 500;">To date</span>
                                <span style="font-size: 12px; font-weight: 600;">{{ $leaveRequest->to_date->format('d M, Y') }} <br><span style="color: #494F55;font-size: 0.755rem; font-weight: normal;">{{ $leaveRequest->to_session }}</span></span>
                            </div>
        ...
        <div class="details" style="  padding:0px 15px;line-height:2;">
           ...
           @if(is_array($leaveRequest['applying_to']) || is_object($leaveRequest['applying_to']))
            @foreach($leaveRequest['applying_to'] as $applyingTo)
            <p style=" font-size: 11px; "><span style="color: #778899; font-size: 11px; font-weight: 400;padding-right: 65px;">Applying to</span  >{{ $applyingTo['report_to'] }}</p>
            @endforeach
            @endif
             <div style="display:flex; flex-direction:row;">
             <span style="color: #778899; font-size: 11px; font-weight: 400;padding-right: 88px; ">Reason</span>
           ...
           <div class="group mx-2">
               <div >
                  <h5 class="mt-3" style="color: #333; font-size: 10px; font-weight: 400; text-align:start;">Submitted<br>
